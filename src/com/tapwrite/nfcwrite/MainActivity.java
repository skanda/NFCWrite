...
public class MainActivity extends Activity {
   ...
   //         Sounds.PlayFailed(context, silent);
    ...
    private NdefMessage getTagAsNdef() {
    	...
    	String uniqueId = "Quaffle";       
        byte[] uriField = uniqueId.getBytes();
       
     //   System.arraycopy(uniqueId, 0, payload, 1, uriField.length);  //appends URI to payload
